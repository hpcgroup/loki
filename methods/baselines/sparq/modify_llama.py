...
from .utils import mask_attn_sparq

def get_sparq_forward(top_r, top_k):
    def modified_forward(
        ...
        **kwargs,
        ...
        attn_weights, alpha = mask_attn_sparq(attn_weights, attention_mask, query_states, key_states, top_r, top_k)
...
def make_llama_attention_sparq(top_r, top_k):
    print ("Modifying Llama Attention -> SparQ Attention")
    print (f"TopR: {top_r}, TopK: {top_k}")
    LlamaAttention.forward = get_sparq_forward(top_r, top_k)